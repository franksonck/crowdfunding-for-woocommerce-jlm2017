...
class Alg_WC_Crowdfunding_Settings_Product_Info {
	...
	public function __construct() {
		...
		$this->desc = __( 'Product Info', 'alg-woocommerce-crowdfunding' );
	...
	function get_settings() {
		...
		$settings = array(
			...
			array(
				'title' => __( 'Custom Product Tab', 'alg-woocommerce-crowdfunding' ),
				'type'  => 'title',
				'id'    => 'alg_woocommerce_crowdfunding_product_tab_options'
			),

			array(
				'title'     => __( 'Add Product Info to Custom Tab on Single Product Page', 'alg-woocommerce-crowdfunding' ),
				'desc'      => __( 'Add', 'alg-woocommerce-crowdfunding' ),
			...
			array(
				'title'     => __( 'Custom Tab Title', 'alg-woocommerce-crowdfunding' ),
				'id'        => 'alg_woocommerce_crowdfunding_product_tab_title',
				'default'   => __( 'Crowdfunding', 'alg-woocommerce-crowdfunding' ),
				'type'      => 'text',
			),

			array(
				'title'   => __( 'Info', 'alg-woocommerce-crowdfunding' ),
			...
			array(
				'title'   => __( 'Order', 'alg-woocommerce-crowdfunding' ),
			...
			array(
				'title' => __( 'Custom Product Info', 'alg-woocommerce-crowdfunding' ),
				'type'  => 'title',
				'id'    => 'alg_woocommerce_crowdfunding_product_info_options'
			),

			array(
				'title'     => __( 'Add Product Info to Single Product Page', 'alg-woocommerce-crowdfunding' ),
				'desc'      => __( 'Add', 'alg-woocommerce-crowdfunding' ),
			...
			array(
				'title'   => __( 'Position', 'alg-woocommerce-crowdfunding' ),
				'id'      => 'alg_woocommerce_crowdfunding_product_info_filter',
				'default' => 'woocommerce_before_single_product_summary',
				'type'    => 'select',
				'options' => array(
					'woocommerce_before_single_product_summary' => __( 'Before single product summary', 'alg-woocommerce-crowdfunding' ),
					'woocommerce_after_single_product_summary'  => __( 'After single product summary',  'alg-woocommerce-crowdfunding' ),
					'woocommerce_single_product_summary'        => __( 'Inside single product summary', 'alg-woocommerce-crowdfunding' ),
				),
			),
			...
			array(
				'title' => __( 'Custom Product Info - Category View', 'alg-woocommerce-crowdfunding' ),
				'type'  => 'title',
				'id'    => 'alg_woocommerce_crowdfunding_product_info_archives_options'
			),

			array(
				'title'     => __( 'Add Product Info to Archives Pages', 'alg-woocommerce-crowdfunding' ),
				'desc'      => __( 'Add', 'alg-woocommerce-crowdfunding' ),
			...
			array(
				...
				'type'    => 'select',
				'options' => array(
					'woocommerce_before_shop_loop_item'       => __( 'Before product', 'alg-woocommerce-crowdfunding' ),
					'woocommerce_before_shop_loop_item_title' => __( 'Before product title', 'alg-woocommerce-crowdfunding' ),
					'woocommerce_after_shop_loop_item'        => __( 'After product', 'alg-woocommerce-crowdfunding' ),
					'woocommerce_after_shop_loop_item_title'  => __( 'After product title', 'alg-woocommerce-crowdfunding' ),
				),
			),
			...
			array(
				'title' => __( 'Product Price', 'alg-woocommerce-crowdfunding' ),
				'type'  => 'title',
				'id'    => 'alg_woocommerce_crowdfunding_product_info_price_options'
			),

			array(
				'title'     => __( 'Hide Main Price for Variable Crowdfunding Products', 'alg-woocommerce-crowdfunding' ),
				'desc'      => __( 'Hide', 'alg-woocommerce-crowdfunding' ),
